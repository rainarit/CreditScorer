...
class Question4ViewController: UIViewController {
    ...
    func buttonPressed(sender: UIButton) {
        ...
        case "Tidak Ada":
            q4Answer = q4Answer + 72
        case "1":
            q4Answer = q4Answer + 91
        case "1 - 3":
            q4Answer = q4Answer + 112
        case "3 - 5":
            q4Answer = q4Answer + 137
        case "5 - 10":
            q4Answer = q4Answer + 106
        case "Lebih dari 10":
            q4Answer = q4Answer + 62
        default:
            break
        }
        let defaults = UserDefaults.standard
        defaults.set(q4Answer, forKey: "q4")
